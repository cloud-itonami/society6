...
(defn collection
  [name]
  (str "com.etzhayyim.society6." name))

(def cell-specs {
  :health {:legacy-cell "com-etzhayyim-apps-society6-health"
     :phase :event
  ...
  :get {:legacy-cell "com-etzhayyim-apps-society6-coverage-get"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :s6rank {:legacy-cell "com-etzhayyim-apps-society6-s6Rank"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "s6rank")]
     :required-gates common-gates
     :trigger "manifest cell s6rank"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :s6achievement {:legacy-cell "com-etzhayyim-apps-society6-s6Achievement"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "s6achievement")]
     :required-gates common-gates
     :trigger "manifest cell s6achievement"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :s6event {:legacy-cell "com-etzhayyim-apps-society6-s6Event"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "s6event")]
     :required-gates common-gates
     :trigger "manifest cell s6event"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
